...
/**
 *
 * cardNumber retrieve state for cardNumber to give value to input
 * cardHolder retrieve state for cardHolder to give value to input
 * cardMonth retrieve state for cardMonth to give value to input
 * cardYear retrieve state for cardYear to give value to input
 * cardCvv retrieve state for cardCvv to give value to input
 *
 * */
...
/**
 *
 * onCardElementClick will do the focus action
 *
 */

/**
 * These below property will act as reference for card form. it act as id for the current div
 * so if we type input on form. the div on div card will be focused
 *
 * cardNumberRef
 * cardHolderRef
 * cardDateRef
